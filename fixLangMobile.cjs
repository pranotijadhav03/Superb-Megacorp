...
if (code.includes(target)) {
    ...
    console.log("Fixed language button mobile visibility");
} else {
    console.log("Language button target not found");
}
